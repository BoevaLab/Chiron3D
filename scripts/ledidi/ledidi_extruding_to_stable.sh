...
#SBATCH --output=/cluster/work/boeva/shoenig/ews-ml/ledidi_tests/extruding_to_stable/Chr1_stuff.txt
...
python -u ledidi_extruding_to_stable.py \
        --ckpt "${CKPT}" \
        --csv_out "${CSV_OUT}" \
        --device cuda \
        --run_dir /cluster/work/boeva/shoenig/ews-ml/ledidi_tests/extruding_to_stable
